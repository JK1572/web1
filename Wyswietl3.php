...
<div id = "page">
	...
	{	
		...
		if($rezultat = @$polaczenie->query("SELECT * FROM ogloszenia WHERE miasto = 'Leszno'"))
		{
			...
			while ($wiersz = mysqli_fetch_array($rezultat))
			{
				...
				<div class = "panelOgloszenie">
					...
					<div class = "zdjecieobok">
						<div class = "miasto">$wiersz[2]</div>
						<div class = "kg">cena: $wiersz[4]    </div>
						<div class = "zasieg">zasieg: $wiersz[3]    </div>
						<div class = "telefon">telefon: $wiersz[6]    </div>
					</div>
